"""
Vendored from smartmoneyconcepts v0.0.27
Source: https://github.com/joshyattridge/smart-money-concepts
License: MIT — Copyright (c) Josh Attridge

Vendored to avoid banner output, numba/llvmlite transitive deps,
and to ensure stability across Python versions.
"""
